    ...
    <aside class="page-sidebar">
        ...
        <nav id="js-primary-nav" class="primary-nav" role="navigation">
            ...
            <div class="info-card">
                ...
                <img
                    :src="'/admin/img/card-backgrounds/cover-2-lg.png'"
                    class="cover"
                    alt="cover"
                />
                <a
            ...
            <ul id="js-nav-menu" class="nav-menu">
                ...
                <li :class="[{ open: $route.name === 'postCategory' }]">
                    <a
                        href="#"
                    ...
                    <ul>
                        <li
                            :class="[
                                { active: $route.name === 'postCategory' },
                            ]"
                        >
                            <router-link
                                title="How it works"
                ...
                <li>
                    <a
                        href="#"
                        title="Package Info"
                        data-filter-tags="package info"
                    >
                        <i class="fal fa-tag"></i>
                        <span class="nav-link-text" data-i18n="nav.package_info"
                            >Package Info</span
                        >
                    </a>
                    <ul>
                ...
                <li>
                    <a href="#" title="Utilities" data-filter-tags="utilities">
                        ...
                        <span class="nav-link-text" data-i18n="nav.utilities"
                            >Utilities</span
                        >
                    </a>
                    <ul>
                ...
                <li>
                    <a
                        href="#"
                        title="Font Icons"
                        data-filter-tags="font icons"
                    >
                        <i class="fal fa-map-marker-alt"></i>
                        <span class="nav-link-text" data-i18n="nav.font_icons"
                            >Font Icons</span
                        >
                        <span
                ...
                <li>
                    <a href="#" title="Tables" data-filter-tags="tables">
                        ...
                        <span class="nav-link-text" data-i18n="nav.tables"
                            >Tables</span
                        >
                    </a>
                    <ul>
                ...
                <li>
                    <a
                        href="#"
                        title="Form Stuff"
                        data-filter-tags="form stuff"
                    >
                        <i class="fal fa-edit"></i>
                        <span class="nav-link-text" data-i18n="nav.form_stuff"
                            >Form Stuff</span
                        >
                    </a>
                    <ul>
                ...
                <li>
                    <a href="#" title="Plugins" data-filter-tags="plugins">
                        ...
                        <span class="nav-link-text" data-i18n="nav.plugins"
                            >Core Plugins</span
                        >
                    </a>
                    <ul>
                        ...
                        <li>
                            ...
                            >
                                <span
                                    class="nav-link-text"
                                    data-i18n="nav.plugins_waves"
                                    >Waves</span
                                >
                                <span class="dl-ref label bg-primary-400 ml-2"
                                    >9 KB</span
                                >
                            </a>
                        </li>
                        <li>
                            ...
                            >
                                <span
                                    class="nav-link-text"
                                    data-i18n="nav.plugins_pacejs"
                                    >PaceJS</span
                                >
                                <span class="dl-ref label bg-primary-500 ml-2"
                                    >13 KB</span
                                >
                            </a>
                        </li>
                        <li>
                            ...
                            >
                                <span
                                    ...
                                    >SmartPanels</span
                                >
                                <span class="dl-ref label bg-primary-600 ml-2"
                                    >9 KB</span
                                >
                            </a>
                        </li>
                        ...
                        <li>
                            ...
                            >
                                <span
                                    ...
                                    >Slimscroll</span
                                >
                                <span class="dl-ref label bg-primary-700 ml-2"
                                    >5 KB</span
                                >
                            </a>
                        </li>
                        ...
                        <li>
                            ...
                            >
                                <span
                                    ...
                                    >App.Core</span
                                >
                                <span class="dl-ref label bg-success-700 ml-2"
                                    >14 KB</span
                                >
                            </a>
                        </li>
                ...
                <li>
                    <a
                        href="#"
                        title="Datatables"
                        data-filter-tags="datatables datagrid"
                    >
                        <i class="fal fa-table"></i>
                        <span class="nav-link-text" data-i18n="nav.datatables"
                            >Datatables</span
                        >
                        <span
                            class="dl-ref bg-primary-500 hidden-nav-function-minify hidden-nav-function-top"
                ...
                <li>
                    ...
                    >
                        ...
                        <span class="nav-link-text" data-i18n="nav.statistics"
                            >Statistics</span
                        >
                    </a>
                    <ul>
                ...
                <li>
                    <a
                        href="#"
                        title="Notifications"
                        data-filter-tags="notifications"
                    >
                        <i class="fal fa-exclamation-circle"></i>
                        <span
                            class="nav-link-text"
                            data-i18n="nav.notifications"
                            >Notifications</span
                        >
                    </a>
                    <ul>
                ...
                <li>
                    <a
                        href="#"
                        title="Form Plugins"
                        data-filter-tags="form plugins"
                    >
                        <i class="fal fa-credit-card-front"></i>
                        <span class="nav-link-text" data-i18n="nav.form_plugins"
                            >Form Plugins</span
                        >
                    </a>
                    <ul>
                ...
                <li>
                    <a href="#" title="Pages" data-filter-tags="pages">
                        ...
                        <span class="nav-link-text" data-i18n="nav.pages"
                            >Page Views</span
                        >
                    </a>
                    <ul>
