        ...
        <div class="page-inner">
            ...
            <aside class="page-sidebar">
                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <div class="info-card">
                        <img src="{{ asset('admin/img/demo/avatars/avatar-admin.png') }}" class="profile-image rounded-circle"
                    ...
                    <ul id="js-nav-menu" class="nav-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="info_app_docs.html" title="Documentation"
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="plugin_faq.html" title="Plugins FAQ"
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="form_plugin_imagecropper.html" title="Image Cropper"
                                            ...
                                            <ul class="notification">
                                                    ...
                                                    <a href="#" class="d-flex align-items-center">
                                                        <span class="status mr-2">
                                                            <span class="profile-image rounded-circle d-inline-block"
                                                                style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-c.png') }}')"></span>
                                                        </span>
                                                ...
                                                <li class="unread">
                                                    <a href="#" class="d-flex align-items-center">
                                                        <span class="status mr-2">
                                                            <span class="profile-image rounded-circle d-inline-block"
                                                                style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-a.png') }}')"></span>
                                                        </span>
                                                        <span class="d-flex flex-column flex-1 ml-1">
                                                ...
                                                <li>
                                                    <a href="#" class="d-flex align-items-center">
                                                        <span class="status status-success mr-2">
                                                            <span class="profile-image rounded-circle d-inline-block"
                                                                style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-b.png') }}')"></span>
                                                        </span>
                                                        <span class="d-flex flex-column flex-1 ml-1">
                                                ...
                                                <li>
                                                    <a href="#" class="d-flex align-items-center">
                                                        <span class="status status-warning mr-2">
                                                            <span class="profile-image rounded-circle d-inline-block"
                                                                style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-e.png') }}')"></span>
                                                        </span>
                                                        <span class="d-flex flex-column flex-1 ml-1">
                                                ...
                                                <li>
                                                    <a href="#" class="d-flex align-items-center">
                                                        <span class="status status-success mr-2">
                                                            <!-- <img src="{{ asset('admin/img/demo/avatars/avatar-m.png') }}" data-src="{{ asset('admin/img/demo/avatars/avatar-h.png') }}" class="profile-image rounded-circle" alt="Sarah McBrook" /> -->
                                                            <span class="profile-image rounded-circle d-inline-block"
                                                                style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-h.png') }}')"></span>
                                                        </span>
                                                        <span class="d-flex flex-column flex-1 ml-1">
                                                ...
                                                <li>
                                                    <a href="#" class="d-flex align-items-center">
                                                        <span class="status status-success mr-2">
                                                            <span class="profile-image rounded-circle d-inline-block"
                                                                style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-m.png') }}')"></span>
                                                        </span>
                                                        <span class="d-flex flex-column flex-1 ml-1">
                                                ...
                                                <li>
                                                    <a href="#" class="d-flex align-items-center">
                                                        <span class="status status-danger mr-2">
                                                            <span class="profile-image rounded-circle d-inline-block"
                                                                style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-j.png') }}')"></span>
                                                        </span>
                                                        <span class="d-flex flex-column flex-1 ml-1">
                                    ...
                                    <div class="tab-pane" id="tab-feeds" role="tabpanel">
                                        <div class="custom-scroll h-100">
                                            <ul class="notification">
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center show-child-on-hover">
                                                        <!--<img src="{{ asset('admin/img/demo/avatars/avatar-m.png') }}" data-src="{{ asset('admin/img/demo/avatars/avatar-k.png') }}" class="profile-image rounded-circle" alt="k" />-->
                                                        <div class="d-flex flex-column flex-1">
                                                            <span class="name">
                                                            ...
                                                            <div class="fs-sm d-flex align-items-center mt-2">
                                                                <span
                                                                    ...
                                                                    style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-a.png') }}'); background-size: cover;"></span>
                                                                <span
                                                                    class="profile-image-md mr-1 rounded-circle d-inline-block"
                                                                    style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-b.png') }}'); background-size: cover;"></span>
                                                                <span
                                                                    class="profile-image-md mr-1 rounded-circle d-inline-block"
                                                                    style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-c.png') }}'); background-size: cover;"></span>
                                                                <span
                                                                    class="profile-image-md mr-1 rounded-circle d-inline-block"
                                                                    style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-e.png') }}'); background-size: cover;"></span>
                                                                <div data-hasmore="+3"
                                                                    class="rounded-circle profile-image-md mr-1">
                                                                    <span
                                                                        class="profile-image-md mr-1 rounded-circle d-inline-block"
                                                                        style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-h.png') }}'); background-size: cover;"></span>
                                                                </div>
                                                            </div>
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center show-child-on-hover">
                                                        <!--<img src="{{ asset('admin/img/demo/avatars/avatar-m.png') }}" data-src="{{ asset('admin/img/demo/avatars/avatar-e.png') }}" class="profile-image-sm rounded-circle align-self-start mt-1" alt="k" />-->
                                                        <div class="d-flex flex-column flex-1">
                                                            ...
                                                            <div class="fs-sm d-flex align-items-center mt-1">
                                                                <a href="#" class="mr-1 mt-1" title="Cell A-0012">
                                                                    <span class="d-block img-share"
                                                                        style="background-image:url('{{ asset('admin/img/thumbs/pic-7.png') }}'); background-size: cover;"></span>
                                                                </a>
                                                                <a href="#" class="mr-1 mt-1"
                                                                    title="Patient A-473 saliva">
                                                                    <span class="d-block img-share"
                                                                        style="background-image:url('{{ asset('admin/img/thumbs/pic-8.png') }}'); background-size: cover;"></span>
                                                                </a>
                                                                <a href="#" class="mr-1 mt-1"
                                                                    title="Patient A-473 blood cells">
                                                                    <span class="d-block img-share"
                                                                        style="background-image:url('{{ asset('admin/img/thumbs/pic-11.png') }}'); background-size: cover;"></span>
                                                                </a>
                                                                <a href="#" class="mr-1 mt-1"
                                                                    title="Patient A-473 Membrane O.C">
                                                                    <span class="d-block img-share"
                                                                        style="background-image:url('{{ asset('admin/img/thumbs/pic-12.png') }}'); background-size: cover;"></span>
                                                                </a>
                                                            </div>
                                                            <span class="fs-nano text-muted mt-1">55 minutes ago</span>
                                                        </div>
                                                ...
                                                <li>
                                                    <div class="d-flex align-items-center show-child-on-hover">
                                                        <!--<img src="{{ asset('admin/img/demo/avatars/avatar-m.png') }}" data-src="{{ asset('admin/img/demo/avatars/avatar-h.png') }}" class="profile-image rounded-circle align-self-start mt-1" alt="k" />-->
                                                        <div class="d-flex flex-column flex-1">
                                                            <div class="name mb-2">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class='subheader-icon fal fa-'></i> Page <span class='fw-300'>Title</span> <sup
                    ...
                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                        <span class="mr-2">
                            <span class="rounded-circle profile-image d-block"
                                style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-d.png') }}'); background-size: cover;"></span>
                        </span>
                        <div class="info-card-text">
                                ...
                                <ul id="js-msgr-listfilter" class="list-unstyled m-0">
                                    ...
                                    <li>
                                        <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                            ...
                                            <div class="d-table-cell align-middle status status-success status-sm ">
                                                <span class="profile-image-md rounded-circle d-block"
                                                    style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-g.png') }}'); background-size: cover;"></span>
                                            </div>
                                            <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                <div class="text-truncate text-truncate-md">
                                                    Ali Amdaney
                                    ...
                                    <li>
                                        <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                            ...
                                            <div class="d-table-cell align-middle status status-danger status-sm">
                                                <span class="profile-image-md rounded-circle d-block"
                                                    style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-j.png') }}'); background-size: cover;"></span>
                                            </div>
                                            <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                <div class="text-truncate text-truncate-md">
                                                    oliver.kopyuv@gotbootstrap.com
                                    ...
                                    <li>
                                        <a href="#" class="d-table w-100 px-2 py-2 text-dark hover-white"
                                            ...
                                            <div class="d-table-cell align-middle">
                                                <span class="profile-image-md rounded-circle d-block"
                                                    style="background-image:url('{{ asset('admin/img/demo/avatars/avatar-m.png') }}'); background-size: cover;"></span>
                                            </div>
                                            <div class="d-table-cell w-100 align-middle pl-2 pr-2">
                                                <div class="text-truncate text-truncate-md">
                                                    +714651347790
